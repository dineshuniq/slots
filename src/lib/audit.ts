...
export const AUDIT_ACTIONS = {
  ...
  mockCompleted: "mock.completed",
  mockReopened: "mock.reopened",
...
export const AUDIT_ACTION_LABELS: { action: AuditAction; label: string }[] = [
  ...
  { action: AUDIT_ACTIONS.mockCompleted, label: "Mock completed" },
  { action: AUDIT_ACTIONS.mockReopened, label: "Mock reopened" },
